 ...
 * Use the [onboarding_two.newInstance] factory method to
...
class onboarding_two : Fragment() {
    ...
    private lateinit var onb_3 : onboarding_three
    ...
    override fun onCreateView(
        ...
        onb_3 = onboarding_three()
        var v =  inflater.inflate(R.layout.fragment_onboarding_two, container, false)
        isClicked(v)
        return v
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment onboarding_two.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            onboarding_two().apply {
